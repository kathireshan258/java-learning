 ...
 * sum is 1 + 2 + 3 = 6
 * isPerfectNumber(28); should return true since its proper divisors are 1, 2, 4, 7, 14 and the
 * sum is 1 + 2 + 4 + 7 + 14 = 28
...
public class PerfectNumber {
  static void main() {
    System.out.println("Is 6 a perfect number: " + isPerfectNumber(6)); // true
    System.out.println("Is 28 a perfect number: " + isPerfectNumber(28)); // true
    System.out.println("Is 5 a perfect number: " + isPerfectNumber(5)); // false
    System.out.println("Is -1 a perfect number: " + isPerfectNumber(-1)); // false
  }
